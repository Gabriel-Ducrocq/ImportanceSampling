...
prior = np.random.normal(0, 1, 1000)*COSMO_PARAMS_SIGMA[0] + COSMO_PARAMS_MEAN[0]
plt.hist(sampled_thetas, weights = normalized_weights, density = True, alpha = 0.05, label = "Posterior")
plt.hist(prior, density = True, alpha = 0.05, label = "Prior", bins = 100)
